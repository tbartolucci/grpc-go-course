...
func (c *calculatorServiceClient) Decompose(ctx context.Context, in *PrimeRequest, opts ...grpc.CallOption) (CalculatorService_DecomposeClient, error) {
...
func (x *calculatorServiceDecomposeClient) Recv() (*PrimeResponse, error) {
	m := new(PrimeResponse)
...
func (UnimplementedCalculatorServiceServer) Decompose(*PrimeRequest, CalculatorService_DecomposeServer) error {
...
func (x *calculatorServiceDecomposeServer) Send(m *PrimeResponse) error {
