...
func (x *AverageResponse) GetAnswer() float32 {
	if x != nil {
		return x.Answer
	}
	return 0
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x28, 0x02, 0x52, 0x06, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x32, 0xdb, 0x01, 0x0a, 0x11, 0x43,
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	3, // 4: calculator.CalculatorService.Decompose:output_type -> calculator.PrimeResponse
